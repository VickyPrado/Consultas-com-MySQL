CALL novoAluguel_32('10010','Victorino Vila','8635','2023-03-30','2023-04-04',40);

SELECT * FROM clientes WHERE nome = 'Victorino Vila';
SELECT * FROM alugueis WHERE aluguel_id = '10010;';
DELETE FROM alugueis WHERE aluguel_id = '10010;';
...
CALL novoAluguel_33('10010','Victorino Vila','8635','2023-03-30','2023-04-04',40);
